...
// LifStatsIndexFilter lif stats indices that needs to be filtered from nicctl output
type LifStatsIndexFilter int32

const (
	LifStatsIndexFilter_UNSPECIFIED               LifStatsIndexFilter = 0 // to be ignored, first enum value must be zero in proto3.
	LifStatsIndexFilter_RX_UNICAST_PACKETS        LifStatsIndexFilter = 1
	LifStatsIndexFilter_RX_UNICAST_DROP_PACKETS   LifStatsIndexFilter = 7
	LifStatsIndexFilter_RX_MULTICAST_DROP_PACKETS LifStatsIndexFilter = 9
	LifStatsIndexFilter_RX_BROADCAST_DROP_PACKETS LifStatsIndexFilter = 11
	LifStatsIndexFilter_RX_DMA_ERROR              LifStatsIndexFilter = 12
	LifStatsIndexFilter_TX_UNICAST_PACKETS        LifStatsIndexFilter = 14
	LifStatsIndexFilter_TX_UNICAST_DROP_PACKETS   LifStatsIndexFilter = 20
	LifStatsIndexFilter_TX_MULTICAST_DROP_PACKETS LifStatsIndexFilter = 22
	LifStatsIndexFilter_TX_BROADCAST_DROP_PACKETS LifStatsIndexFilter = 24
	LifStatsIndexFilter_TX_DMA_ERROR              LifStatsIndexFilter = 25
)

// Enum value maps for LifStatsIndexFilter.
var (
	LifStatsIndexFilter_name = map[int32]string{
		0:  "UNSPECIFIED",
		1:  "RX_UNICAST_PACKETS",
		7:  "RX_UNICAST_DROP_PACKETS",
		9:  "RX_MULTICAST_DROP_PACKETS",
		11: "RX_BROADCAST_DROP_PACKETS",
		12: "RX_DMA_ERROR",
		14: "TX_UNICAST_PACKETS",
		20: "TX_UNICAST_DROP_PACKETS",
		22: "TX_MULTICAST_DROP_PACKETS",
		24: "TX_BROADCAST_DROP_PACKETS",
		25: "TX_DMA_ERROR",
	}
	LifStatsIndexFilter_value = map[string]int32{
		"UNSPECIFIED":               0,
		"RX_UNICAST_PACKETS":        1,
		"RX_UNICAST_DROP_PACKETS":   7,
		"RX_MULTICAST_DROP_PACKETS": 9,
		"RX_BROADCAST_DROP_PACKETS": 11,
		"RX_DMA_ERROR":              12,
		"TX_UNICAST_PACKETS":        14,
		"TX_UNICAST_DROP_PACKETS":   20,
		"TX_MULTICAST_DROP_PACKETS": 22,
		"TX_BROADCAST_DROP_PACKETS": 24,
		"TX_DMA_ERROR":              25,
	}
)

func (x LifStatsIndexFilter) Enum() *LifStatsIndexFilter {
	p := new(LifStatsIndexFilter)
	*p = x
	return p
}

func (x LifStatsIndexFilter) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (LifStatsIndexFilter) Descriptor() protoreflect.EnumDescriptor {
	return file_nic_proto_enumTypes[0].Descriptor()
}

func (LifStatsIndexFilter) Type() protoreflect.EnumType {
	return &file_nic_proto_enumTypes[0]
}

func (x LifStatsIndexFilter) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use LifStatsIndexFilter.Descriptor instead.
func (LifStatsIndexFilter) EnumDescriptor() ([]byte, []int) {
...
var file_nic_proto_rawDesc = []byte{
	...
	0x4e, 0x49, 0x43, 0x2a, 0xb0, 0x02, 0x0a, 0x13, 0x4c, 0x69, 0x66, 0x53, 0x74, 0x61, 0x74, 0x73,
	0x49, 0x6e, 0x64, 0x65, 0x78, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x12, 0x0f, 0x0a, 0x0b, 0x55,
	...
	,
}
...
var file_nic_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_nic_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_nic_proto_goTypes = []any{
	(LifStatsIndexFilter)(0), // 0: nicmetrics.LifStatsIndexFilter
	(*PortStats)(nil),        // 1: nicmetrics.PortStats
	(*NICPortStats)(nil),     // 2: nicmetrics.NICPortStats
	(*PortStatsList)(nil),    // 3: nicmetrics.PortStatsList
	(*LStats)(nil),           // 4: nicmetrics.LStats
...
var file_nic_proto_depIdxs = []int32{
	1, // 0: nicmetrics.NICPortStats.Port:type_name -> nicmetrics.PortStats
	2, // 1: nicmetrics.PortStatsList.NIC:type_name -> nicmetrics.NICPortStats
	4, // 2: nicmetrics.LifStats.Statistics:type_name -> nicmetrics.LStats
	5, // 3: nicmetrics.NICLifStats.Lif:type_name -> nicmetrics.LifStats
	6, // 4: nicmetrics.LifStatsList.NIC:type_name -> nicmetrics.NICLifStats
...
func file_nic_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_nic_proto_enumTypes,
