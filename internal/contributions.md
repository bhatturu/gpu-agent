...
- Create a local branch from the shadow copy of the upstream branch you want to work on. This helps rebasing to be cleaner and avoid conflict.
- If your branch has diverged from main a lot with your changes, consider creating a new branch from upstream then cherry-pick commits.
